...
public class MenuFoodItem3 extends AppCompatActivity {

    private float basePrice = 7.84f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_food_item3);
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FoodMenuItem foodItem = new FoodMenuItem(R.drawable.pudding_pie, title_text.getText().toString(),
