...
public class MenuFoodItem2 extends AppCompatActivity {

    private float basePrice = 10.99f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_food_item2);
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FoodMenuItem foodItem = new FoodMenuItem(R.drawable.tuna_bowl, title_text.getText().toString(),
